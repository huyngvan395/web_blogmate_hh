...
<section>
    ...
    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>
                <svg wire:loading wire:target="updatePassword" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
